	...
	<div class="container">
		<div class="row isotope-grid product">
			<c:forEach var="product" items="${products}" >
				<div class="col-sm-6 col-md-4 col-lg-3 p-b-35 isotope-item women productMainImg" index="${status.index}">
					<!-- Block2 -->
					<div class="block2">
						...
						<div class="block2-txt flex-w flex-t p-t-14">
							<div class="block2-txt-child1 flex-col-l ">
								<a href="productDetail.do?pcode=${product.productCode }"
...
<div class="wrap-modal1 js-modal1 p-t-60 p-b-20">
	...
	<div class="container container-modal1">
		<div
			class="bg0 p-t-60 p-b-30 p-lr-15-lg how-pos3-parent container-modal1">
